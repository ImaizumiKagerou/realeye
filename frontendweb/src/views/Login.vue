          ...
          <article>
            <form action="#" method="post">
              ...
              <div class="input">
                ...
                <input v-model="logindata.email" name="email" placeholder="邮箱" required type="email"/>
              </div>
              <div class="input">
              ...
              <button class="btn submit" type="button">登 录</button>
          ...
          <article>
            <form action="#" method="post">
              ...
              <div class="input">
                ...
                <input v-model="registerdata.name" name="name" placeholder="用户名" required type="text"/>
              </div>
              <div class="input">
                <span aria-hidden="true" class="fa fa-key"></span>
              ...
              <button class="btn submit" type="button">注 册</button>
            </form>
          </article>
        </div>
