...
import com.realeye.frontend.utils.jwt.utils.PasswordEncoder;
...
public class JwtAuthenticationProvider extends DaoAuthenticationProvider {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails, UsernamePasswordAuthenticationToken
        ...
        String salt = ((JwtUserDetails) userDetails).getUsername();
        // 覆写密码验证逻辑
        PasswordEncoder newPass = new PasswordEncoder(salt);
        if (newPass.matches(userDetails.getPassword(), presentedPassword)) {
